...
========================
ICARUS main namespace
========================

.. currentmodule:: ICARUS
...
:doc:`ICARUS.Control`           Module to model control systems
:doc:`ICARUS.Mission`           Module to simulate missions using abstractions
:doc:`ICARUS.Visualization`     Module to visualize data
:doc:`ICARUS.Core`              Core classes and methods that are used throughout the package but are not specific to any one module
==============================  ======================================================================================================
