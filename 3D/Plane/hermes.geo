...
0.0          AMOVEAB  -1  1st value of amplitude
0.0          AMOVEAB  -2  2nd value of amplitude
...
0.          TMOVEAB  -3  3d  time step
0.          TMOVEAB  -4  4th time step
0.0          AMOVEAB  -1  1st value of amplitude  (Initial MR phase + 0)
0.0          AMOVEAB  -2  2nd value of amplitude
0.          AMOVEAB  -3  3d  value of amplitude
0.          AMOVEAB  -4  4th value of amplitude
            FILTMSA  file name for TIME SERIES [IMOVEB=6]
...
1           IYNVCR(1)
4415.cld      FLCLCD      file name wherefrom Cl, Cd are read
               <blank>
...
Cl, Cd data / IYNVCR(.)=0 then Cl=1., Cd=0.
1           IYNVCR(1)
0008.cld      FLCLCD      file name wherefrom Cl, Cd are read
               <blank>
Give the file name for the geometrical distributions
Ltail.bld
               <blank>
