...
def main():
    ...
    # # Get Plane
    planes = list()
    planes.append(wing_var_chord_offset(airfoils ,"orthogonal",
                                        [0.159,0.159],0.0))

    planes.append(wing_var_chord_offset(airfoils ,"orthogonalSweep",
                                        [0.159,0.159],0.2))

    planes.append(wing_var_chord_offset(airfoils ,"taperSweep",
                                        [0.159,0.072],0.2))

    planes.append(wing_var_chord_offset(airfoils ,"taper",
                                        [0.159,0.072],0.0))
    ...
    for ap in planes:
        ...
        gnvp3.run()
        print(f"Polars took : --- {time.time() - polars_time} seconds --- in Parallel Mode")
