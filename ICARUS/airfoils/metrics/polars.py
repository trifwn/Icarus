...
class AirfoilPolar:
    ...
    def plot_cl(
        ...
        ax.plot(self.angles, self.cl_curve, label=f"Reynolds {self.reynolds:,}", color=color)
        ax.set_xlabel("Angle of Attack [deg]")
        ax.set_ylabel("Lift Coefficient")
        ax.set_title(f"Reynolds {self.reynolds:,} Cl Curve")
        ax.legend()
        ax.grid(True)
    ...
    def plot_cd(
        ...
        ax.plot(self.angles, self.cd_curve, label=f"Reynolds {self.reynolds:,}", color=color)
        ax.set_xlabel("Angle of Attack [deg]")
        ax.set_ylabel("Drag Coefficient")
        ax.set_title(f"Reynolds {self.reynolds:,} Cd Curve")
        ax.legend()
        ax.grid(True)
        ax.axvline(self.zero_lift_angle, color="r", linestyle="--")
        ax.axhline(0.0, color="k", linestyle="--")
    ...
    def plot_cl_over_cd(
        ...
        ax.plot(self.angles, cl_over_cd, label=f"Reynolds {self.reynolds:,}", color=color)
        ax.set_xlabel("Angle of Attack [deg]")
        ax.set_ylabel("Lift to Drag Ratio")
        ax.set_title(f"Reynolds {self.reynolds:,} Cl/Cd Curve")
        ax.legend()
        ax.grid(True)
        ax.axvline(self.zero_lift_angle, color="r", linestyle="--")
        ax.axhline(0.0, color="k", linestyle="--")
