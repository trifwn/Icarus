    ...
    def save_polar_plot_img(self, folder: str, filename: str | None = None) -> None:
        ...
        if filename is None:
            filename = os.path.join(
                folder,
                f"{self.airfoil_name}_{self.solver_name}_polars.png",
            )
        else:
