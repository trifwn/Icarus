        ...
        **missing_vals: dict[str, bool],
        ...
        if not self.get_missing_parameters():
            res = get_all_far_criteria(
                ...
                AREA=self.AREA,
                MTOW=self.MTOW,
                FAR_TAKEOFF_DISTANCE=self.FAR_TAKEOFF_DIST,  # noqa
                FAR_LANDING_DISTANCE=self.FAR_LANDING_DIST,  # noqa
                NO_OF_ENGINES=self.NO_OF_ENGINES,  # noqa
                THRUST=self.THRUST,  # noqa
                CD_0=self.CD_0,
                CD_LANDING=self.CD_LANDING,  # noqa
                CD_CLIMB=self.CD_CLIMB,  # noqa
                OSWALD_LANDING=self.OSWALD_LANDING,
                OSWALD_CLIMB=self.OSWALD_CLIMB,
                OSWALD_CRUISE=self.OSWALD_CRUISE,
                CL_APP=self.CL_APP,  # noqa
                CL_CRUISE=self.CL_CRUISE,  # noqa
                CL_TAKEOFF=self.CL_TAKEOFF,  # noqa
                CL_CLIMB=self.CL_CLIMB,  # noqa
                CRUISE_ALTITUDE=self.CRUISE_ALTITUDE_MAX,
                CRUISE_MACH=self.CRUISE_MACH,
                L_OVER_D=self.L_OVER_D,  # noqa
