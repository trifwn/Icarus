...
from ICARUS.solvers.Foil2Wake.analyses.monitor_progress import parallel_monitor
from ICARUS.solvers.Foil2Wake.analyses.monitor_progress import serial_monitor
from ICARUS.solvers.Foil2Wake.files_interface import sequential_run
from ICARUS.solvers.Foil2Wake.post_process.polars import make_polars
...
def run_multiple_reynolds_parallel(
    ...
    max_iter: float = solver_parameters["max_iter"]
...
def run_multiple_reynolds_sequentially(
    ...
    for i, reyn in enumerate(reynolds):
        ...
        run_single_reynolds(airfoil, reyn, mach, angles, solver_parameters, i)
...
def process_f2w_run(
    ...
    for reyn in reynolds_list:
        ...
        polars[reynolds_str] = make_polars(CASEDIR)
